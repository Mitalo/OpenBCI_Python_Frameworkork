...
class QDA(SKLearnClassifier):
    ...
    Attributes:
        _MODULE_NAME (str): The name of the module(in this case ``node.processing.trainable.classifier.qda``)

    configuration.json usage: 
        **module** (*str*): The name of the module (``node.processing.trainable.classifier``)\n
        **type** (*str*): The name of the class (``QDA``)\n
    ...
    """
    _MODULE_NAME: Final[str] = 'node.processing.trainable.classifier.qda'
