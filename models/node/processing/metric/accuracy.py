...
class accuracy(ProcessingNode):
    ...
    Attributes:
        _MODULE_NAME (str): The name of the module (``node.processing.metric.accuracy``).
    ...
    ```json
    {
        "module": "models.node.processing.metric.accuracy",
        "type": "ROCAUC",
        "outputs": {
            "main": [
                {
    ...
    _MODULE_NAME: Final[str] = 'node.processing.metric.accuracy'
